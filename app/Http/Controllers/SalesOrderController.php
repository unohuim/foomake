...
class SalesOrderController extends Controller
{
     ...
     */
    public function show(Request $request, SalesOrder $salesOrder, AuthShellPayloadBuilder $authShellPayloadBuilder): Response
    {
    ...
    private function ordersCrudConfig(): array
    {
        return [
            ...
            'mobileCard' => [
                'titleExpression' => '`SO-${record.id}`',
                'titleAsideExpression' => "record.date || 'No order date'",
                'titleAsidePlacement' => 'top-right',
                'titleBadgesExpression' => 'salesOrderTitleBadges(record)',
                'subtitleExpression' => 'record.customer_name || "Customer not set"',
                'detailRowsExpression' => 'salesOrderCardRows(record)',
                'bodyExpression' => '',
                'showBody' => false,
                'showActions' => false,
                'urlExpression' => 'record.show_url',
