    ...
    >
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <x-detail-section-card
                title="Details"
                :description="__('Update count metadata separately from material lines and workflow tasks.')"
                :default-open="true"
            >
                <div class="space-y-3">
                    <div class="grid grid-cols-2 gap-2">
                        <div class="space-y-1">
                            ...
                            <input
                                ...
                                x-bind:disabled="!count.can_edit_details || detailsCountedAtSaving"
                        ...
                        <div class="space-y-1">
                            ...
                            <x-dropdown-select
                                ...
                                disabled-expression="!count.can_edit_details || detailsAssignmentSaving"
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea
                            ...
                            x-bind:disabled="!count.can_edit_details || detailsNotesSaving"
