            ...
            @if (data_get($payload, 'item.can_manage'))
                <x-slot name="titleSuffix">
                    <div class="relative" x-data="materialNameEditor" data-material-name-editor>
                        <button
                            type="button"
                            class="inline-flex h-7 w-7 items-center justify-center rounded-md text-gray-400 transition hover:text-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600"
                ...
                <div class="relative" x-data="materialTypeToggles" data-material-type-toggles>
                    <div class="flex items-center gap-2">
                        <template x-for="typeToggle in materialTypeToggles" :key="typeToggle.field">
                            <button
                                type="button"
                                class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 bg-white transition disabled:cursor-not-allowed disabled:opacity-70"
                            ...
                            >
                                ...
                                <template x-if="typeToggle.icon === 'shopping-cart'">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-[1.125rem] w-[1.125rem]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
