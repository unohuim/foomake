...
import MarketingViewDropdown from "./MarketingViewDropdown.vue";
    ...
    <div class="flex h-full min-h-0 flex-col">
        <section class="shrink-0 border-b border-slate-200 pb-3">
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    <p class="text-[11px] font-semibold uppercase tracking-widest text-slate-500">Google Search Console</p>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a
                        ...
                        class="inline-flex cursor-pointer items-center justify-center border border-slate-300 px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-50"
                    >
                        Manage
                    </a>
                </div>
        ...
        <section v-if="searchConsole.connected" class="mt-3 flex min-h-0 flex-1 flex-col border border-slate-200 bg-white shadow-sm">
