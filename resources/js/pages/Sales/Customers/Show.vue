                            ...
                            <div class="p-6">
                                <div class="flex items-start justify-between">
                                    <div>
                                        ...
                                        <p class="mt-1 text-lg font-semibold text-gray-900">{{ customer.status }}</p>
                                    </div>

                                    <div v-if="canManage" class="inline-flex items-center gap-3">
                                        <button type="button" class="cursor-pointer text-blue-600 hover:text-blue-500" @click="openEdit">Edit</button>
                                        <button type="button" class="cursor-pointer text-yellow-600 hover:text-yellow-500" @click="archiveCustomer">Archive</button>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 grid gap-6 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-base text-gray-900">{{ customer.customer_type_label || "-" }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-500">Preferred Currency</p>
                                        <p class="mt-1 text-base text-gray-900">{{ customer.currency_code || "Tenant default" }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-500">Notes</p>
                                        <p class="mt-1 whitespace-pre-line text-base text-gray-900">{{ customer.notes || "-" }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-8 rounded-2xl border border-gray-200 bg-gray-50/70 p-6">
                                    <div class="flex items-start justify-between gap-4">
                                        ...
                                        <p v-if="customer.address_summary" class="text-sm text-gray-500">{{ customer.address_summary }}</p>
                                    </div>

                                    <div class="mt-6 grid gap-6 sm:grid-cols-2">
                                        <div><p class="text-sm text-gray-500">Address line 1</p><p class="mt-1 text-base text-gray-900">{{ customer.address_line_1 || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Address line 2</p><p class="mt-1 text-base text-gray-900">{{ customer.address_line_2 || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">City</p><p class="mt-1 text-base text-gray-900">{{ customer.city || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Region</p><p class="mt-1 text-base text-gray-900">{{ customer.region || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Postal code</p><p class="mt-1 text-base text-gray-900">{{ customer.postal_code || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Country code</p><p class="mt-1 text-base text-gray-900">{{ customer.country_code || "-" }}</p></div>
                                        <div class="sm:col-span-2"><p class="text-sm text-gray-500">Formatted address</p><p class="mt-1 whitespace-pre-line text-base text-gray-900">{{ customer.formatted_address || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Latitude</p><p class="mt-1 text-base text-gray-900">{{ customer.latitude || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Longitude</p><p class="mt-1 text-base text-gray-900">{{ customer.longitude || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Address provider</p><p class="mt-1 text-base text-gray-900">{{ customer.address_provider || "-" }}</p></div>
                                        <div><p class="text-sm text-gray-500">Provider ID</p><p class="mt-1 text-base text-gray-900">{{ customer.address_provider_id || "-" }}</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
